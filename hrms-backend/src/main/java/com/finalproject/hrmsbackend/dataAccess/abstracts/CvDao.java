...
public interface CvDao extends JpaRepository<Cv, Integer> {
    ...
    @Modifying
    @Query(value = "INSERT INTO candidates_cvs_job_experiences VALUES (:cvId, :candidateJobExpId)", nativeQuery = true)
    void addJobExpToCv(@Param(value = "candidateJobExpId") Integer candidateJobExpId, @Param(value = "cvId") Integer cvId);

    @Modifying
    @Query(value = "INSERT INTO candidates_cvs_languages VALUES (:cvId, :candidateLangId)", nativeQuery = true)
    ...
    @Modifying
    @Query(value = "DELETE FROM candidates_cvs_job_experiences WHERE cv_id = :cvId AND candidate_job_exp_id = :candidateJobExpId", nativeQuery = true)
    void deleteJobExpFromCv(@Param(value = "candidateJobExpId") Integer candidateJobExpId, @Param(value = "cvId") Integer cvId);

    @Modifying
    @Query(value = "DELETE FROM candidates_cvs_languages WHERE cv_id = :cvId AND candidate_language_id = :candidateLangId", nativeQuery = true)
