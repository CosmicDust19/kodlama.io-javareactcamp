...
import {
    changeCvJobExp, changeCvLang, changeCvSchool,
    changeCvSkill, changeJobExps, changeLangs,
    changeSchools, changeSkills,
...
export function CandidateProfile() {
    ...
    const handleSkillAdd = () => {
        const index = user.candidateSkills.findIndex(candidateSkill => candidateSkill.skill.id === formik.values.skill.id)
        if (index !== -1) {
            toast.warning(ALREADY_HAVE)
            return
        }
